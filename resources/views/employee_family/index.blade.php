        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex justify-content-between">
                    <div>
                        <h5 class="card-title mb-0 flex-grow-1">Employee Family</h5>
                    </div>

                    <div class="justify-content-md-end">
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-primary waves-effect waves-light material-shadow-none me-1" id="add-new-user-family-btn">New Family Details <i class="ri-add-line"></i></button>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4 mb-2">
                            ...
                            <button type="button" class="btn w-sm btn-primary" id="user-family-submit-confirm">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(async function() {
        ...
        async function getEmployeeList() {
            let users = await commonFetchData('/employee/family/dropdown');
            ...
            if (users && users.length > 0) {
                ...
                if (userId) {
                    ...
                    await renderEmployeeFamilyTable(userId);
                }
            } else {
        ...
        async function renderEmployeeFamilyTable() {
            if (!userId) {
                $('#user-family-table-body').html('<tr><td colspan="11" class="text-center">Selecte Employee...</td></tr>');
                    return;
                }

            let users_family = await commonFetchData(`/employee/family/${userId}`);
            let list = '';
            ...
            if (users_family && users_family.length > 0) {
                ...
                list = `<tr><td colspan="11" class="text-danger text-center">No Employee Family Yet!</td></tr>`;
            }
        ...
        $(document).on('click', '#user-family-submit-confirm', async function() {
            ...
            let createUrl = `/employee/family/create`;
            let updateUrl = `/employee/family/update/${family_id}`;
        ...
        $(document).on('click', '.click-edit-user-family', async function() {
            ...
            try {
                let family_data = await commonFetchData(`/employee/single_employee_family/${family_id}`);
        ...
        $(document).on('click', '.click-delete-user-family', async function() {
            ...
            try {
                let url = `/employee/family/delete`;
                const res = await commonDeleteFunction(family_id, url, 'Employee Family');
