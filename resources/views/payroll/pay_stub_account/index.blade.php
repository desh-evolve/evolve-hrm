        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex justify-content-between">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary waves-effect waves-light material-shadow-none me-1" id="new_absence_click">New Pay Stub Account<i class="ri-add-line"></i></button>
                    </div>
                </div>
                <div class="card-body">
