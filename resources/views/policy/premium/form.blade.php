                ...
                <div class="card-body">
                    <form>
                        ...
                        <div id="milestone_rollover_section">
                            ...
                            <div class="row mb-3">
                                <label for="type" class="form-label mb-1 col-md-3">Branches</label>
                                <div class="col-md-9">
                                    <select class="form-select" id="type">
                                        <option value="date_time">Date/Time</option>
                                        <option value="shift_differential">Shift Differential</option>
                            ...
                            <div class="row mb-3">
                                <label for="type" class="form-label mb-1 col-md-3">Departments</label>
                                <div class="col-md-9">
                                    <select class="form-select" id="type">
                                        <option value="date_time">Date/Time</option>
                                        <option value="shift_differential">Shift Differential</option>
                        ...
                        <div id="milestone_rollover_section">
                            ...
                            <div class="row mb-3">
                                <label for="type" class="form-label mb-1 col-md-3">Pay Type</label>
                                <div class="col-md-9">
                                    <select class="form-select" id="type">
