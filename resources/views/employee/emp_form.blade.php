            ...
            <div class="card">
                <form action="{{ url('/employee/create') }}" method="POST" class="form-steps" autocomplete="on" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header align-items-center d-flex justify-content-center bg-primary">
                            <div>
                                <h4 id="employee-details-title" class="card-title mb-0 text-center text-white"></h4>
                            </div>
                        </div>

                        <div class="step-arrow-nav mb-1">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="steparrow-basic-info" role="tabpanel" aria-labelledby="steparrow-basic-info-tab">
                                <div class="row">
                                    <div class="col-lg-6 border-end">
                                        ...
                                        <div class="row border-top pt-2">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="terminated_date">Termination Date</label>
                                                    <input type="date" class="form-control" id="terminated_date" name="terminated_date" />
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="terminated_note">Termination Note</label>
                                                    <textarea class="form-control" id="terminated_note" name="terminated_note" placeholder="Enter Termination Note"></textarea>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="bond_period" name="bond_period" required>
                                                        <option value="">Select</option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="resigned_date">Resign Date</label>
                                                    <input type="date" class="form-control" id="resigned_date" name="resigned_date" />
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row border-bottom">
                                            <div class="col-lg-6">
                                                <div class=" mt-3 mb-3">
                                                    <label class="form-label req" for="employment_type">Basis of Employment</label>
                                            ...
                                            <div class="col-lg-6" id="month-selection" style="display: none;">
                                                <div class="mt-3 mb-3">
                                                    ...
                                                    <input type="number" class="form-control numonly" id="employment_time" name="employment_time" min="1" max="12" placeholder="Enter months">
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex justify-content-end mb-2 align-items-start gap-1">
                                    <!-- Offset Position -->
                                    <button type="reset" data-toast data-toast-text="Clear Employee Identification All fields!" data-toast-gravity="top" data-toast-position="right" data-toast-duration="3000" data-toast-offset data-toast-close="close" class="btn btn-secondary reset-user-form">Clear</button>
                            ...
                            <div class="tab-pane fade" id="steparrow-contact-info" role="tabpanel" aria-labelledby="steparrow-contact-info-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="epf_reg_no" name="epf_reg_no" placeholder="Enter EPF Reg No" />
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex align-items-start mt-4 justify-content-between">
                                    ...
                                    <div>
                                        <button type="reset" data-toast data-toast-text="Clear Contact Information All fields!" data-toast-gravity="top" data-toast-position="right" data-toast-duration="3000" data-toast-offset data-toast-close="close" class="btn btn-secondary reset-contact-form">Clear</button>
                            ...
                            <div class="tab-pane fade" id="steparrow-document-info" role="tabpanel" aria-labelledby="steparrow-document-info-tab">
                                ...
                                <div id="document-error-msg" style="width: auto"></div>
                                ...
                                <div id="submit-error-msg" style="width: auto"></div>

                                <div class="d-flex align-items-start gap-3 mt-6">
                                    <input type="hidden" name="user_id" id="user_id" />
                                    {{-- back to general button --}}
                                    <button type="button" class="btn btn-light btn-label previestab border" data-previous="steparrow-contact-info-tab" id="back-button">
