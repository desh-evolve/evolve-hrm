        ...
        try {
            return DB::transaction(function () use ($request) {
                ...
                $request->validate([
                    ...
                    'apply_frequency_month' => 'nullable|integer|min:0|max:12',
                    'apply_frequency_day_of_month' => 'nullable|integer|min:0|max:31',
                    ...
                    'milestone_rollover_month' => 'nullable|integer|min:0|max:12',
                    'milestone_rollover_day_of_month' => 'nullable|integer|min:0|max:31',
